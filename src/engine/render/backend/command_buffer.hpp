...
namespace render {
    ...
    public:
        ...
        void clear_texture(TextureHandle texture) const;

        void build_acceleration_structures(
            eastl::span<const VkAccelerationStructureBuildGeometryInfoKHR> build_geometry_infos,
            eastl::span<VkAccelerationStructureBuildRangeInfoKHR* const> build_range_info_ptrs
        ) const;
        ...
        void set_scissor_rect(VkRect2D rect) const;
        ...
        void set_topology(VkPrimitiveTopology topology) const;

        void set_fill_mode(VkPolygonMode fill_mode) const;
    ...
    private:
        ...
        eastl::stack<std::unique_ptr<tracy::VkCtxScope>> tracy_stack;
#endif
