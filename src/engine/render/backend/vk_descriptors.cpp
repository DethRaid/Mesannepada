...
namespace render {
    namespace vkutil {
        ...
        static bool is_descriptor_array(const VkDescriptorSetLayoutBinding& binding) {
            ...
            return binding.descriptorCount == variable_descriptor_array_max_size &&
        ...
        DescriptorAllocator::DescriptorAllocator(const bool supports_rt) {
            descriptorSizes.sizes = {{VK_DESCRIPTOR_TYPE_SAMPLER, 0.5f},
            ...
            if(supports_rt) {
                descriptorSizes.sizes.emplace_back(VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR, 0.5f);
            }
        }
        ...
        bool
        DescriptorAllocator::allocate(VkDescriptorSet* set, VkDescriptorSetLayout layout,
        ...
        vkutil::DescriptorBuilder DescriptorBuilder::begin(RenderBackend& backend,
                                                           vkutil::DescriptorAllocator& allocator) {
            return DescriptorBuilder{backend, allocator};
        }

        DescriptorBuilder& DescriptorBuilder::bind_buffer(const uint32_t binding,
                                                          const DescriptorBuilder::BufferInfo& info,
                                                          const VkDescriptorType type,
                                                          const VkShaderStageFlags stage_flags) {
            auto& vk_info = buffer_infos_to_delete.emplace_back(eastl::vector{VkDescriptorBufferInfo{
        ...
        DescriptorBuilder& DescriptorBuilder::bind_buffer_array(const uint32_t binding,
                                                                const eastl::span<BufferInfo> infos,
                                                                const VkDescriptorType type,
                                                                const VkShaderStageFlags stage_flags) {
            ...
            for(const auto& info : infos) {
                vk_infos.emplace_back(VkDescriptorBufferInfo{
                    .buffer = info.buffer->buffer,
                    .offset = info.offset,
                    .range = info.range > 0 ? info.range : info.buffer->create_info.size,
                });
        ...
        DescriptorBuilder& DescriptorBuilder::bind_image(const uint32_t binding, const ImageInfo& info,
                                                         const VkDescriptorType type,
                                                         const VkShaderStageFlags stage_flags) {
            ...
            auto& vk_info = image_infos_to_delete.emplace_back(eastl::vector{VkDescriptorImageInfo{
        ...
        DescriptorBuilder& DescriptorBuilder::bind_image_array(const uint32_t binding,
                                                               const eastl::span<ImageInfo> infos,
                                                               const VkDescriptorType type,
                                                               const VkShaderStageFlags stage_flags) {
            ...
            for(const auto& info : infos) {
                ...
                vk_infos.emplace_back(VkDescriptorImageInfo{
                    .sampler = info.sampler,
                    .imageView = image_view,
                    .imageLayout = info.image_layout,
                });
        ...
        DescriptorBuilder& DescriptorBuilder::bind_acceleration_structure(const uint32_t binding,
            ...
            if(info.as) {
                desc_as_info = &as_writes.emplace_back(VkWriteDescriptorSetAccelerationStructureKHR{
        ...
        DescriptorBuilder& DescriptorBuilder::bind_image(const uint32_t binding,
        ...
        eastl::optional<VkDescriptorSet> DescriptorBuilder::build(VkDescriptorSetLayout& layout) {
            const auto variable_descriptor_array_max_size =
                static_cast<uint32_t>(*CVarSystem::Get()->GetIntCVar("r.RHI.SampledImageCount"));
        ...
        eastl::optional<VkDescriptorSet> DescriptorBuilder::build() {
            VkDescriptorSetLayout layout;
            return build(layout);
        }

        DescriptorBuilder::DescriptorBuilder(RenderBackend& backend_in, vkutil::DescriptorAllocator& allocator_in) :
