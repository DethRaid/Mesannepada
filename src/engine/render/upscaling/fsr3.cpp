        ...
        graph.add_pass(
            {
                ...
                .execute = [&](CommandBuffer& commands) {
                    ...
                    const auto average_exposure_in_res = FfxApiResource{
                        .resource = average_exposure_in->image,
                        .description = ffxApiGetImageResourceDescriptionVK(
                            average_exposure_in->image,
                            average_exposure_in->create_info,
                            0),
                        .state = FFX_API_RESOURCE_STATE_COMPUTE_READ
                    };
                    ...
                    local_dispatch_desc.exposure = average_exposure_in_res;
